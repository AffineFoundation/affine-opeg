...
#
# This is a modified version of the zss package (MIT), vendored from
# github.com/phybench-official/phybench (EED/extended_zss.py, MIT License,
# Copyright (c) 2025 phybench-official). Kept verbatim except this header.
