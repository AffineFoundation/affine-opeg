# Vendored verbatim from github.com/phybench-official/phybench (EED/EED.py,
# MIT License, Copyright (c) 2025 phybench-official). Only the two intra-package
# imports below were repointed to our vendored siblings; the algorithm is
# unchanged. EED(answer_latex, test_latex) -> (score, rel_distance, tree_size,
# distance_number); score is 0-100 (100 = symbolically equal).
from sympy import *
from sympy.core.function import AppliedUndef
from sympy.core.numbers import Pi, Exp1, I, Infinity, NegativeInfinity
import numpy as np
import timeout_decorator
from affine_opeg.adapters.envs_builtin.phybench_extended_zss import ext_distance
from affine_opeg.adapters.envs_builtin.phybench_latex_pre_process import master_convert
